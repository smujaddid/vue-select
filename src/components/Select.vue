...
<template>
  <div :dir="dir" class="dropdown v-select" :class="dropdownClasses">
    <div ref="toggle" @mousedown.left.prevent="toggleDropdown" class="dropdown-toggle">
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
       ...
       */
      toggleDropdown(e) {
        if (e.target === this.$refs.openIndicator || e.target === this.$refs.search || e.target === this.$refs.toggle || e.target === this.$refs.selectedOptions ||
